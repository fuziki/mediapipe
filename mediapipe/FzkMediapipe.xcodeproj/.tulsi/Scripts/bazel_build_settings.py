...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_macbookpro/3f7f7f1ca618f544da3138c058954fca/execroot/mediapipe',
    'ios_x86_64',
    {
        'watchos_arm64_32': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/macbookpro/Library/Application Support/Tulsi/0.20200219.88/Bazel',
